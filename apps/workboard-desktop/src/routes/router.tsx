...
const proposalRoute = createRoute({ getParentRoute: () => rootRoute, path: "/workspaces/$workspaceId/features/$featureId/proposal", component: () => { const { workspaceId, featureId } = proposalRoute.useParams(); return <ProposalPage workspaceId={workspaceId} featureId={featureId} />; } });
...
const routeTree = rootRoute.addChildren([indexRoute, workspaceRoute, repositoryRoute, epicRoute, featureRoute, workItemRoute, savedViewRoute, boardRoute, attentionRoute, approvalQueueRoute, proposalRoute, checkoutRoute, sessionRoute]);
