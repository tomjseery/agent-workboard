...
`plans/` is the repository's planning source of truth. Read
[`plans/PLANS.md`](plans/PLANS.md) before creating, changing, or executing an Epic, Feature, or Work item.
...
- Never hand-edit the live Workboard SQLite database or planning-store repository to repair a failed workflow.
